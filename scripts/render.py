...
.mock-chip{font-size:var(--t-2xs);font-weight:680;padding:.13rem .48rem;border-radius:var(--radius-pill)}
...
.mock-find-h{display:flex;gap:.45rem;align-items:center;font-size:var(--t-xs);font-weight:640;color:var(--text)}
.mock-rank{background:var(--brand-soft);color:var(--brand-light);font-size:var(--t-3xs);font-weight:720;
...
.bar-val{font-size:var(--t-sm);font-weight:680;color:var(--text);font-variant-numeric:tabular-nums}
