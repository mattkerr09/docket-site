...
it needs to is a different question, and it is the one with the uncomfortable answer:
<a href="/learn/ai-substitution/">which of your pages an answer replaces outright</a>.</p>
...
page that cannot be crawled scores zero on everything downstream, however good its content.
