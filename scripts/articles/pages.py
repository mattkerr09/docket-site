...
<h3><code>scout logs</code> — what Googlebot actually fetched</h3>
<pre><code>scout logs access.log
scout logs access.log.gz --url https://example.com
scout logs access.log --verify           # confirm the bot really was Google</code></pre>

<p>A crawl tells you what a search engine <em>could</em> reach. A server log tells you what it
did reach, how often, and what it wasted requests on. Point Scout at a Common or Combined
...
Scout gives you is the comparison that answers "is Google spending its time on my important
