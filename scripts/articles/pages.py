...
itself. If macOS warns that the app is from an unidentified developer, right-click the app and
choose Open — that is the standard path for software distributed outside the App Store.</p>
