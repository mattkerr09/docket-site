...
echo "==> positioning gate"
# brand.positioning fired on this site on 2026-09-15, on every page carrying a
# description: beyond the brand name, no word reached the share of pages the
# check asks for. The fix was editorial — twelve descriptions rewritten around
# "Docket audits your site on your own Mac" — and an editorial property decays
# without anything saying so. This runs the shipped check, not a copy of it.
"$PY" scripts/verify_positioning.py
